const SectionFour = () => {
    ...
    return (
        <div className="w-full h-[600px] md:h-[737px] bg-[#EEEEEE] relative overflow-hidden flex flex-col-reverse items-center md:items-start md:flex-row ">
            ...
            <div className="hidden md:block w-[25vw] h-[25vw] xl:w-[405px] xl:h-[405px] bg-[#B7D2EF] rounded-full p-[.2vw] absolute top-[-9vw] right-[-12vw] xl:top-[4%] xl:right-[-15%]">
                <div className="w-full h-full rounded-full bg-gradient-to-b to-[#E6EAEE] from-[#E7EBEE]"></div>
            </div>

            <div className="hidden md:block w-[50vw] h-[50vw] xl:w-[754px] xl:h-[754px] bg-[#FFF] rounded-full p-[.2vw] absolute bottom-[-17vw] left-[-17vw] xl:bottom-[-40%] xl:left-[-10%]">
            ...
            <div className="w-full h-full z-[999] pt-[80px] md:pt-[180px]">
                <div className="w-[80%] h-[80%] mx-auto flex flex-col lg:flex-row items-center justify-center">
                    ...
                    <div className="w-full md:w-[60%] h-full">
                        ...
                        <div className="w-[100%] my-[5vw] sm:my-[3vw] md:my-0 md:mt-[4vw] lg:mt-[3vw] flex flex-wrap gap-4">
